...
namespace ReversiMvcApp
{
    public class SpelersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Naam,Guid,AantalGewonnen,AantalVerloren,AantalGelijk")] Speler speler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Naam,Guid,AantalGewonnen,AantalVerloren,AantalGelijk")] Speler speler)
        {
            if (id != speler.Guid)
            {
                return NotFound();
